...
rxs1 = PrescriptionSchedule.create!(prescription: rx1, day_of_week: 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday', time_of_day: '12:00', as_needed: false )
rxs2 = PrescriptionSchedule.create!(prescription: rx2, day_of_week: 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday', time_of_day: '13:00', as_needed: false )
...
rxs5 = PrescriptionSchedule.create!(prescription: rx1, day_of_week: 'Monday,Tuesday,Wednesday,Thursday,Friday', time_of_day: '14:00', as_needed: false )
rxs6 = PrescriptionSchedule.create!(prescription: rx2, day_of_week: 'Monday,Wednesday,Friday,Sunday', time_of_day: '15:00', as_needed: false )
